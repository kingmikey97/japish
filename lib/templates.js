...
import LayoutSinganiSanPedro from "@/components/profile-layouts/LayoutSinganiSanPedro";
...
export const templates = {
  ...
  10: {
    ...
    colors: {
      ...
      buttonPrimary:
        "from-pink-500 to-violet-600 hover:from-pink-600 hover:to-violet-700",
      buttonSecondary: "bg-white/5 hover:bg-white/10",
  ...
  12: {
    ...
    colors: {
      ...
      buttonPrimary:
        "from-teal-400 to-sky-500 hover:from-teal-500 hover:to-sky-600",
  ...
  15: {
    ...
    //SINGANI
    colors: {
      background: "from-[#5c000f] via-[#7a0018] to-[#3a000a]",
      card: "bg-gradient-to-br from-[#1a0a0a]/90 to-black/80 backdrop-blur-md",
      cardBorder: "border-[#d4af6a]/30",
      primary: "text-[#faf6ee]",
      secondary: "text-[#e8c988]/70",
      accent: "text-[#d4af6a]",
      buttonPrimary:
        "from-[#7a0018] to-[#9b1224] hover:from-[#8c001c] hover:to-[#ad1529]",
      buttonSecondary: "bg-[#d4af6a]/5 hover:bg-[#d4af6a]/10",
      ringColor: "from-[#d4af6a] via-[#f3d9a4] to-[#d4af6a]",
    },
    ...
    styles: {
      ...
      shadow: "shadow-2xl shadow-[#7a0018]/40",
    },
    ...
    layoutComponent: LayoutSinganiSanPedro,
  },
  101: {
